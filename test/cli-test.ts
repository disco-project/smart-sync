...
describe('Test CLI', async () => {
    ...
    it('should fork', async () => {
        ...
        const forkCommand = `${TestCLI.ts_node_exec} ${TestCLI.cli_exec} f ${srcContract.address} ${relayContract.address} -c ${TestCLI.default_test_config_file}`;
    ...
    it('should fork without relayContract', async () => {
        ...
        const forkCommand = `${TestCLI.ts_node_exec} ${TestCLI.cli_exec} f ${srcContract.address} -c ${TestCLI.default_test_config_file}`;
        logger.debug(`Executing:\n${forkCommand}`);
    ...
    it('should synch (diff mode = srcTx)', async () => {
        ...
        const synchCommand = `${TestCLI.ts_node_exec} ${TestCLI.cli_exec} s ${initialization.proxyContract.address} --src-blocknr ${currBlockNr + 1} -c ${TestCLI.default_test_config_file}`;
        logger.debug(`Executing:\n${synchCommand}`);
    ...
    it('should get latest blocknr from proxy contract', async () => {
        ...
        const stateCommand = `${TestCLI.ts_node_exec} ${TestCLI.cli_exec} blocknr ${initialization.proxyContract.address} -c ${TestCLI.default_test_config_file}`;
        logger.debug(`Executing:\n${stateCommand}`);
