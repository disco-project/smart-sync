import {RelayContract__factory, MappingContract, MappingContract__factory, SyncCandidate__factory, CallRelayContract__factory, CallRelayContract} from "../src-gen/types";
...
describe("Test scaling of contract", async function () {
    ...
    //         if (checker) {
    //             console.log(`'${hex_to_ascii(checker[1])}'`);
    //             console.log(e);
    //         }
    //         else console.log(e);
    //         return;
    ...
    //     console.log("Gas used for updating 1 value in map with 1 value: ", receipt.gasUsed.toNumber());
    ...
    //         else console.log(e);
    //     }
    //     console.log("Gas used for updating first value in map with 10 values: ", receipt.gasUsed.toNumber());
    ...
    //     let receipt = await txResponse.wait();
    //     console.log("Gas used for updating first 5 values in map with 10 values: ", receipt.gasUsed.toNumber());
    ...
    it("Contract with map containing 10 values, update last 5 values", async function() {
        ...
        let txResponse = await proxyContract.updateStorage(rlpProof);
        let receipt = await txResponse.wait();
        console.log("Gas used for updating last 5 values in map with 10 values: ", receipt.gasUsed.toNumber());
    ...
    it("Contract with map containing 10 values, update 10 values", async function() {
        ...
        let txResponse = await proxyContract.updateStorage(rlpProof);
        let receipt = await txResponse.wait();
        console.log("Gas used for updating 1 values in map with 10 values: ", receipt.gasUsed.toNumber());
